...
Spectrum MicrofacetReflection::Sample_f(const ry::vec3& wo, ry::vec3* wi, const ry::vec2& u, float* pdf, BxDFType* sampledType) const
{
...
float TrowbridgeReitzDistribution::Lambda(const ry::vec3& w) const
{
...
float MicrofacetDistribution::Pdf(const ry::vec3& wo, const ry::vec3& wh) const
{
    if (sampleVisibleArea)
